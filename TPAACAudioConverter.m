...
@property (nonatomic, unsafe_unretained) id<TPAACAudioConverterDelegate> delegate;
...
@property (nonatomic, readwrite) UInt32 priorMixOverrideValue;

@end

@implementation TPAACAudioConverter
@synthesize source = _source, destination = _destination, delegate = _delegate, dataSource = _dataSource, audioFormat = _audioFormat, condition = _condition, processing = _processing, cancelled = _cancelled, interrupted = _interrupted, priorMixOverrideValue = _priorMixOverrideValue;
